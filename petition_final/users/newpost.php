...
<head>
	<meta charset="UTF-8">
	<title>New Petition - Admin</title>
...
<body>
	...
	<div class="blog">
		...
		<div class="container-fluid">
			<div class="sidebar">
				<h1 class="sidebar-heading">Petition isg - <?php echo $_SESSION['name']; ?></h1>
				<div class="row">
					<!-- Navbar section -->
					<div class="col-sm-2 sidebar">
						...
						<ul id="side-menu" class="nav nav-pills navig">
							...
							<li class="active"><a href="newpost.php" class="nav-link links-sidebar"><i class="fas fa-list-alt"></i>&nbsp; NEW PETITION</a></li>
							...
							<li><a href="../index.php" class="nav-link links-sidebar"><i class="fab fa-blogger-b"></i>&nbsp; LIVE VIEW</a></li>
					...
					<div class="col-sm-10 content">
						...
						<!-- Add Post Form -->
						<h3 class="post-heading">NEW PETITION</h3>
